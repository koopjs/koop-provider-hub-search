...
describe('enrichDataset function', () => {
    ...
    it('should return geojson with enriched fields in properties field', async () => {
        ...
        const expectedEnrichedProperties = {
            ...
            durableUrlCSV: 'https://arcgis.com/api/download/v1/item/0/csv?layers=0',
            durableUrlGeoJSON: 'https://arcgis.com/api/download/v1/item/0/geojson?layers=0',
            durableUrlShapeFile: 'https://arcgis.com/api/download/v1/item/0/shapefile?layers=0',
